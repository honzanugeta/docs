...
<DescriptionImage src="/img/opsimg/multitasking.jpg">
...
<DescriptionImage src="/img/opsimg/procesy.png">
  S = sleeping, R = running, W = waiting, Z = Mátoha <br />
...
### Zablokovaný proces _stav sleeping_
...
- Sdílený logický prostředek, dva stavy (<Highlight color="red">červená</Highlight>, <Highlight color="green">zelená</Highlight>)
  - **WAIT**: pokud je semafor ve stavu <Highlight color="green">zelená</Highlight>, je bezprostředně přepnut do stavu <Highlight color="red">červená</Highlight>, jinak proces vyčká změny stavu na zelenou (Ta je provedena voláním operace signál jiným procesem a až poté změní sám stav semaforu na červenou)
...
- Lze použít k vzájemnému vyloučení u kritických kódu.
- V dnešní době se již nepoužívá nahrazen MUTEXEM.
...
1. **Detekce potencionálního uváznutí (Predikce)**
   ...
   - Nejznámější algoritmus je _Bankéřův algoritmus_
